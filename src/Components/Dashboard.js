...
//                 <div className="row no-gutters align-items-center">
//                   <div
//                     className={`text-xs font-weight-bold text-${idle.theme} text-uppercase `}
//                   >
//                     {idle.title}
//                   </div>
...
//                   <div
//                     className={`text-xs font-weight-bold text-${info.theme} text-uppercase `}
//                   >
//                     {info.title}
//                   </div>
